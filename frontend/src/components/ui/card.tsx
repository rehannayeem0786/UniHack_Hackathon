...
>(({ className, interactive, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-border/70 bg-card/80 text-card-foreground shadow-card backdrop-blur-sm",
      "transition-all duration-300 hover:border-border hover:shadow-lift",
